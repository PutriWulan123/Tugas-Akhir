            ...
            <tbody>
                @forelse($suratMasuk as $index => $surat)
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modalEdit{{ $surat->id }}">Edit</button>
                            <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#modalDetail{{ $surat->id }}">Detail</button>
